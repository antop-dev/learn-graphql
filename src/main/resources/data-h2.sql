...
insert into employees
values (106, 'Valli', 'Jackson', 'VJACKSON', '1.590.555.0106', '2016-02-05', 'IT_PROG', 4800, NULL, 103, 60);
insert into employees
values (107, 'Diana', 'Nguyen', 'DNGUYEN', '1.590.555.0107', '2017-02-07', 'IT_PROG', 4200, NULL, 103, 60);
insert into employees
values (108, 'Nancy', 'Gruenberg', 'NGRUENBE', '1.515.555.0108', '2012-08-17', 'FI_MGR', 12008, NULL, 101, 100);
insert into employees
values (109, 'Daniel', 'Faviet', 'DFAVIET', '1.515.555.0109', '2012-08-16', 'FI_ACCOUNT', 9000, NULL, 108, 100);
insert into employees
values (110, 'John', 'Chen', 'JCHEN', '1.515.555.0110', '2015-09-28', 'FI_ACCOUNT', 8200, NULL, 108, 100);
insert into employees
values (111, 'Ismael', 'Sciarra', 'ISCIARRA', '1.515.555.0111', '2015-09-30', 'FI_ACCOUNT', 7700, NULL, 108, 100);
insert into employees
values (112, 'Jose Manuel', 'Urman', 'JMURMAN', '1.515.555.0112', '2016-03-07', 'FI_ACCOUNT', 7800, NULL, 108, 100);
insert into employees
values (113, 'Luis', 'Popp', 'LPOPP', '1.515.555.0113', '2017-12-07', 'FI_ACCOUNT', 6900, NULL, 108, 100);
insert into employees
values (114, 'Den', 'Li', 'DLI', '1.515.555.0114', '2012-12-07', 'PU_MAN', 11000, NULL, 100, 30);
insert into employees
values (115, 'Alexander', 'Khoo', 'AKHOO', '1.515.555.0115', '2013-05-18', 'PU_CLERK', 3100, NULL, 114, 30);
insert into employees
values (116, 'Shelli', 'Baida', 'SBAIDA', '1.515.555.0116', '2015-12-24', 'PU_CLERK', 2900, NULL, 114, 30);
insert into employees
values (117, 'Sigal', 'Tobias', 'STOBIAS', '1.515.555.0117', '2015-07-24', 'PU_CLERK', 2800, NULL, 114, 30);
insert into employees
values (118, 'Guy', 'Himuro', 'GHIMURO', '1.515.555.0118', '2016-11-15', 'PU_CLERK', 2600, NULL, 114, 30);
insert into employees
values (119, 'Karen', 'Colmenares', 'KCOLMENA', '1.515.555.0119', '2017-08-10', 'PU_CLERK', 2500, NULL, 114, 30);
insert into employees
values (120, 'Matthew', 'Weiss', 'MWEISS', '1.650.555.0120', '2014-07-18', 'ST_MAN', 8000, NULL, 100, 50);
insert into employees
values (121, 'Adam', 'Fripp', 'AFRIPP', '1.650.555.0121', '2015-04-10', 'ST_MAN', 8200, NULL, 100, 50);
insert into employees
values (122, 'Payam', 'Kaufling', 'PKAUFLIN', '1.650.555.0122', '2013-05-01', 'ST_MAN', 7900, NULL, 100, 50);
insert into employees
values (123, 'Shanta', 'Vollman', 'SVOLLMAN', '1.650.555.0123', '2015-10-10', 'ST_MAN', 6500, NULL, 100, 50);
insert into employees
values (124, 'Kevin', 'Mourgos', 'KMOURGOS', '1.650.555.0124', '2017-11-16', 'ST_MAN', 5800, NULL, 100, 50);
insert into employees
values (125, 'Julia', 'Nayer', 'JNAYER', '1.650.555.0125', '2015-07-16', 'ST_CLERK', 3200, NULL, 120, 50);
insert into employees
values (126, 'Irene', 'Mikkilineni', 'IMIKKILI', '1.650.555.0126', '2016-09-28', 'ST_CLERK', 2700, NULL, 120, 50);
insert into employees
values (127, 'James', 'Landry', 'JLANDRY', '1.650.555.0127', '2017-01-14', 'ST_CLERK', 2400, NULL, 120, 50);
insert into employees
values (128, 'Steven', 'Markle', 'SMARKLE', '1.650.555.0128', '2018-03-08', 'ST_CLERK', 2200, NULL, 120, 50);
insert into employees
values (129, 'Laura', 'Bissot', 'LBISSOT', '1.650.555.0129', '2015-08-20', 'ST_CLERK', 3300, NULL, 121, 50);
insert into employees
values (130, 'Mozhe', 'Atkinson', 'MATKINSO', '1.650.555.0130', '2015-10-30', 'ST_CLERK', 2800, NULL, 121, 50);
insert into employees
values (131, 'James', 'Marlow', 'JAMRLOW', '1.650.555.0131', '2015-02-16', 'ST_CLERK', 2500, NULL, 121, 50);
insert into employees
values (132, 'TJ', 'Olson', 'TJOLSON', '1.650.555.0132', '2017-04-10', 'ST_CLERK', 2100, NULL, 121, 50);
insert into employees
values (133, 'Jason', 'Mallin', 'JMALLIN', '1.650.555.0133', '2014-06-14', 'ST_CLERK', 3300, NULL, 122, 50);
insert into employees
values (134, 'Michael', 'Rogers', 'MROGERS', '1.650.555.0134', '2016-08-26', 'ST_CLERK', 2900, NULL, 122, 50);
insert into employees
values (135, 'Ki', 'Gee', 'KGEE', '1.650.555.0135', '2017-12-12', 'ST_CLERK', 2400, NULL, 122, 50);
insert into employees
values (136, 'Hazel', 'Philtanker', 'HPHILTAN', '1.650.555.0136', '2018-02-06', 'ST_CLERK', 2200, NULL, 122, 50);
insert into employees
values (137, 'Renske', 'Ladwig', 'RLADWIG', '1.650.555.0137', '2013-07-14', 'ST_CLERK', 3600, NULL, 123, 50);
insert into employees
values (138, 'Stephen', 'Stiles', 'SSTILES', '1.650.555.0138', '2015-10-26', 'ST_CLERK', 3200, NULL, 123, 50);
insert into employees
values (139, 'John', 'Seo', 'JSEO', '1.650.555.0139', '2016-02-12', 'ST_CLERK', 2700, NULL, 123, 50);
insert into employees
values (140, 'Joshua', 'Patel', 'JPATEL', '1.650.555.0140', '2016-04-06', 'ST_CLERK', 2500, NULL, 123, 50);
insert into employees
values (141, 'Trenna', 'Rajs', 'TRAJS', '1.650.555.0141', '2013-10-17', 'ST_CLERK', 3500, NULL, 124, 50);
insert into employees
values (142, 'Curtis', 'Davies', 'CDAVIES', '1.650.555.0142', '2015-01-29', 'ST_CLERK', 3100, NULL, 124, 50);
insert into employees
values (143, 'Randall', 'Matos', 'RMATOS', '1.650.555.0143', '2016-03-15', 'ST_CLERK', 2600, NULL, 124, 50);
insert into employees
values (144, 'Peter', 'Vargas', 'PVARGAS', '1.650.555.0144', '2016-07-09', 'ST_CLERK', 2500, NULL, 124, 50);
insert into employees
values (145, 'John', 'Singh', 'JSINGH', '44.1632.960000', '2014-10-01', 'SA_MAN', 14000, .4, 100, 80);
insert into employees
values (146, 'Karen', 'Partners', 'KPARTNER', '44.1632.960001', '2015-01-05', 'SA_MAN', 13500, .3, 100, 80);
insert into employees
values (147, 'Alberto', 'Errazuriz', 'AERRAZUR', '44.1632.960002', '2015-03-10', 'SA_MAN', 12000, .3, 100, 80);
insert into employees
values (148, 'Gerald', 'Cambrault', 'GCAMBRAU', '44.1632.960003', '2017-10-15', 'SA_MAN', 11000, .3, 100, 80);
insert into employees
values (149, 'Eleni', 'Zlotkey', 'EZLOTKEY', '44.1632.960004', '2018-01-29', 'SA_MAN', 10500, .2, 100, 80);
insert into employees
values (150, 'Sean', 'Tucker', 'STUCKER', '44.1632.960005', '2015-01-30', 'SA_REP', 10000, .3, 145, 80);
insert into employees
values (151, 'David', 'Bernstein', 'DBERNSTE', '44.1632.960006', '2015-03-24', 'SA_REP', 9500, .25, 145, 80);
insert into employees
values (152, 'Peter', 'Hall', 'PHALL', '44.1632.960007', '2015-08-20', 'SA_REP', 9000, .25, 145, 80);
insert into employees
values (153, 'Christopher', 'Olsen', 'COLSEN', '44.1632.960008', '2016-03-30', 'SA_REP', 8000, .2, 145, 80);
insert into employees
values (154, 'Nanette', 'Cambrault', 'NCAMBRAU', '44.1632.960009', '2016-12-09', 'SA_REP', 7500, .2, 145, 80);
insert into employees
values (155, 'Oliver', 'Tuvault', 'OTUVAULT', '44.1632.960010', '2017-11-23', 'SA_REP', 7000, .15, 145, 80);
insert into employees
values (156, 'Janette', 'King', 'JKING', '44.1632.960011', '2014-01-30', 'SA_REP', 10000, .35, 146, 80);
insert into employees
values (157, 'Patrick', 'Sully', 'PSULLY', '44.1632.960012', '2014-03-04', 'SA_REP', 9500, .35, 146, 80);
insert into employees
values (158, 'Allan', 'McEwen', 'AMCEWEN', '44.1632.960013', '2014-08-01', 'SA_REP', 9000, .35, 146, 80);
insert into employees
values (159, 'Lindsey', 'Smith', 'LSMITH', '44.1632.960014', '2015-03-10', 'SA_REP', 8000, .3, 146, 80);
insert into employees
values (160, 'Louise', 'Doran', 'LDORAN', '44.1632.960015', '2015-12-15', 'SA_REP', 7500, .3, 146, 80);
insert into employees
values (161, 'Sarath', 'Sewall', 'SSEWALL', '44.1632.960016', '2016-11-03', 'SA_REP', 7000, .25, 146, 80);
insert into employees
values (162, 'Clara', 'Vishney', 'CVISHNEY', '44.1632.960017', '2015-11-11', 'SA_REP', 10500, .25, 147, 80);
insert into employees
values (163, 'Danielle', 'Greene', 'DGREENE', '44.1632.960018', '2017-03-19', 'SA_REP', 9500, .15, 147, 80);
insert into employees
values (164, 'Mattea', 'Marvins', 'MMARVINS', '44.1632.960019', '2018-01-24', 'SA_REP', 7200, .10, 147, 80);
insert into employees
values (165, 'David', 'Lee', 'DLEE', '44.1632.960020', '2018-02-23', 'SA_REP', 6800, .1, 147, 80);
insert into employees
values (166, 'Sundar', 'Ande', 'SANDE', '44.1632.960021', '2018-03-24', 'SA_REP', 6400, .10, 147, 80);
insert into employees
values (167, 'Amit', 'Banda', 'ABANDA', '44.1632.960022', '2018-04-21', 'SA_REP', 6200, .10, 147, 80);
insert into employees
values (168, 'Lisa', 'Ozer', 'LOZER', '44.1632.960023', '2015-03-11', 'SA_REP', 11500, .25, 148, 80);
insert into employees
values (169, 'Harrison', 'Bloom', 'HBLOOM', '44.1632.960024', '2016-03-23', 'SA_REP', 10000, .20, 148, 80);
insert into employees
values (170, 'Tayler', 'Fox', 'TFOX', '44.1632.960025', '2016-01-24', 'SA_REP', 9600, .20, 148, 80);
insert into employees
values (171, 'William', 'Smith', 'WSMITH', '44.1632.960026', '2017-02-23', 'SA_REP', 7400, .15, 148, 80);
insert into employees
values (172, 'Elizabeth', 'Bates', 'EBATES', '44.1632.960027', '2017-03-24', 'SA_REP', 7300, .15, 148, 80);
insert into employees
values (173, 'Sundita', 'Kumar', 'SKUMAR', '44.1632.960028', '2018-04-21', 'SA_REP', 6100, .10, 148, 80);
insert into employees
values (174, 'Ellen', 'Abel', 'EABEL', '44.1632.960029', '2014-05-11', 'SA_REP', 11000, .30, 149, 80);
insert into employees
values (175, 'Alyssa', 'Hutton', 'AHUTTON', '44.1632.960030', '2015-03-19', 'SA_REP', 8800, .25, 149, 80);
insert into employees
values (176, 'Jonathon', 'Taylor', 'JTAYLOR', '44.1632.960031', '2016-03-24', 'SA_REP', 8600, .20, 149, 80);
insert into employees
values (177, 'Jack', 'Livingston', 'JLIVINGS', '44.1632.960032', '2016-04-23', 'SA_REP', 8400, .20, 149, 80);
insert into employees
